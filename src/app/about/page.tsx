                ...
                <section className="mb-12">
                    ...
                    <div className="bg-white rounded-lg p-8 shadow-sm">
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Medica Tradicional Teresa Roldán Soria</h3>
                            <p className="text-green-600 font-medium mb-4">Fundadora y Directora</p>
                            <p className="text-gray-600 max-w-2xl mx-auto">
                                Con más de 10 años de experiencia en medicina tradicional, la Medica Tradicional Teresa ha dedicado su
                                vida al estudio y
